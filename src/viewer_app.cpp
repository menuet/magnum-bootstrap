...
namespace {
    ...
    {
    public:
        explicit ColoredDrawable(ViewerApp::Object3D& object, Shaders::Phong& shader, GL::Mesh& mesh,
    ...
    {
    public:
        explicit TexturedDrawable(ViewerApp::Object3D& object, Shaders::Phong& shader, GL::Mesh& mesh,
...
ViewerApp::ViewerApp(const Arguments& arguments)
    : Platform::Application{
          arguments,
          Configuration{}.setTitle("Magnum Viewer Example").setWindowFlags(Configuration::WindowFlag::Resizable)}
{
    ...
    _coloredShader.setAmbientColor(0x111111_rgbf).setSpecularColor(0xffffff_rgbf).setShininess(80.0f);
    _texturedShader.setAmbientColor(0x111111_rgbf).setSpecularColor(0x111111_rgbf).setShininess(80.0f);
...
void ViewerApp::addObject(Trade::AbstractImporter& importer,
        ...
        _meshes[objectData->instance()])
    {
        ...
        else if (materials[materialId]->flags() & Trade::PhongMaterialData::Flag::DiffuseTexture)
        {
            ...
            if (texture)
                ...
                new ColoredDrawable{*object, _coloredShader, *_meshes[objectData->instance()], 0xffffff_rgbf,
                                    _drawables};
        ...
        {
            new ColoredDrawable{*object, _coloredShader, *_meshes[objectData->instance()],
...
Vector3 ViewerApp::positionOnSphere(const Vector2i& position) const
{
